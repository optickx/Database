...
public class ArtistsManagement {
    ...
    public void updateArtist() {
        ...
        Artist pArtist = pSearch.get(pIndex);
     ...
     * all the results of the datbase.
     */
    public void searchArtistByGenre() {
     ...
     * with that title.
    */
    public void searchSongsByTitle() {
    ...
    public void searchAndSortAlbums() {
    ...
    public void showDebutAlbumOfAnArtist() {
    ...
    public static void addConcert(Artist pArtist) {
        pArtist.addConcert(createConcert(pArtist));
    }


    public void showArtistWithMoreAlbums() {
